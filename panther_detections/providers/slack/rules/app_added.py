        ...
        unit_tests=(
            [
                detection.JSONUnitTest(
                    name="App Approved",
                    expect_match=True,
                    data=sample_logs.app_added_app_approved
                ),
                detection.JSONUnitTest(
                    name="App Installed",
                    expect_match=True,
                    data=sample_logs.app_added_app_installed
                ),
                detection.JSONUnitTest(
                    name="App added to workspace",
                    expect_match=True,
                    data=sample_logs.app_added_app_added_to_workspace
                ),
                detection.JSONUnitTest(
                    name="User Logout",
                    expect_match=False,
                    data=sample_logs.app_added_user_logout
                ),
