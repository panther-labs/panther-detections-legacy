...
def brute_force_logins(
    ...
    return detection.Rule(
        ...
        description=(overrides.description or "A user has failed to login more than 5 times in 15 minutes"),
        reference=(overrides.reference or "https://developer.okta.com/docs/reference/api/system-log/#user-events"),
        runbook=(
            overrides.runbook or "Reach out to the user if needed to validate the activity, and then block the IP"
        ),
