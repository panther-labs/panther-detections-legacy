...
def workspace_apps_marketplace_allowlist(
    ...
    def rule_filter() -> detection.PythonFilter:
        def _rule_filter(event: PantherEvent) -> bool:
            ...
            old_val = deep_get(event, "parameters", "OLD_VALUE",
                               default="<NO_OLD_VALUE_FOUND>")
            new_val = deep_get(event, "parameters", "NEW_VALUE",
                               default="<NO_NEW_VALUE_FOUND>")
    ...
    def _title(event: PantherEvent) -> str:
        ...
        old_val = event.deep_get(
            "parameters", "OLD_VALUE", default="<NO_OLD_VALUE_FOUND>")
        new_val = event.deep_get(
            "parameters", "NEW_VALUE", default="<NO_NEW_VALUE_FOUND>")
