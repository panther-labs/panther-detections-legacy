        ...
        unit_tests=(
            [
                detection.JSONUnitTest(
                    ...
                    expect_match=True,
                    data=sample_logs.admin_promotion_event
                ),
                detection.JSONUnitTest(
                    name="Admin to Admin",
                    expect_match=False,
                    data=sample_logs.admin_to_admin
                ),
                detection.JSONUnitTest(
                    name="Admin to Billing Admin",
                    expect_match=False,
                    data=sample_logs.admin_to_billing_admin
                ),
                detection.JSONUnitTest(
                ...
                detection.JSONUnitTest(
                    name="Admin to User",
                    expect_match=False,
                    data=sample_logs.admin_to_user
                ),
                detection.JSONUnitTest(
                    name="CoOwner to Admin",
                    expect_match=False,
                    data=sample_logs.coowner_to_admin
                ),
                detection.JSONUnitTest(
                    name="Other Event",
                    expect_match=False,
