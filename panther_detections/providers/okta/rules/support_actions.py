...
def account_support_access(
    ...
    return detection.Rule(
        ...
        tags=(overrides.tags or rule_tags(standard_tags.DATA_MODEL, "Initial Access:Trusted Relationship")),
        ...
        description=(overrides.description or "An admin user has granted access to Okta Support to your account"),
        reference=(
            overrides.reference or "https://help.okta.com/en/prod/Content/Topics/Settings/settings-support-access.htm"
        ),
        runbook=(overrides.runbook or "Contact Admin to ensure this was sanctioned activity"),
...
def support_reset(
    ...
    return detection.Rule(
        ...
        description=(overrides.description or "A Password or MFA factor was reset by Okta Support"),
        reference=(
            overrides.reference
            or "https://help.okta.com/en/prod/Content/Topics/Directory/get-support.htm#"
