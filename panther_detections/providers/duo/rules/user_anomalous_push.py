...
def user_anomalous_push(
    ...
    return detection.Rule(
        ...
        + [
            match_filters.deep_equal("reason", "anomalous_push"),
            match_filters.deep_equal("result", "denied")
        ],
        alert_title=_title,
        unit_tests=(
            [
                detection.JSONUnitTest(
                    ...
                    expect_match=True,
                    data=sample_logs.anomalous_push_occurred
                ),
                detection.JSONUnitTest(
                    name="good_auth",
                    expect_match=False,
                    data=sample_logs.good_auth
                ),
                detection.JSONUnitTest(
                    name="denied_old_creds",
                    expect_match=False,
                    data=sample_logs.denied_old_creds
                ),
