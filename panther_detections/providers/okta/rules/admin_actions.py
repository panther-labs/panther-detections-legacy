...
def admin_disabled_mfa(
    ...
    return detection.Rule(
        ...
        description=(overrides.description or "An admin user has disabled the MFA requirement for your Okta account"),
        reference=(
            overrides.reference
...
def admin_role_assigned(
    ...
    return detection.Rule(
        ...
        description=(overrides.description or "A user has been granted administrative privileges in Okta"),
        reference=(
            overrides.reference
